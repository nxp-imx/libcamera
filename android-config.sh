...
cp -f $PRODUCT_PATH/vendor/lib64/libfsldisplay.so $NDK_LIB_PATH
cp -f $PRODUCT_PATH/system/lib64/libcutils.so $NDK_LIB_PATH
cp -f $PRODUCT_PATH/vendor/lib64/hw/android.hardware.graphics.allocator-V1-arm.so $NDK_LIB_PATH
