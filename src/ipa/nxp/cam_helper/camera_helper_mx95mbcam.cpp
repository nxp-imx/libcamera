...
constexpr std::initializer_list<uint32_t> registerList [[maybe_unused]] = {
	AecHcgCtrl01Reg, AecHcgCtrl02Reg,
	AecHcgCtrl08Reg, AecHcgCtrl09Reg, AecHcgCtrl0aReg, AecHcgCtrl0bReg,
	AecHcgCtrl0cReg,
	AecSpdCtrl01Reg, AecSpdCtrl02Reg,
	AecSpdCtrl08Reg, AecSpdCtrl09Reg, AecSpdCtrl0aReg, AecSpdCtrl0bReg,
	AecSpdCtrl0cReg,
	AecLcgCtrl08Reg, AecLcgCtrl09Reg, AecLcgCtrl0aReg, AecLcgCtrl0bReg,
	AecLcgCtrl0cReg,
	AecVsCtrl01Reg, AecVsCtrl02Reg,
	AecVsCtrl08Reg, AecVsCtrl09Reg, AecVsCtrl0aReg, AecVsCtrl0bReg, AecVsCtrl0cReg,
	MipiCtrl3eReg, MipiCtrl3fReg,
	TmpReg26Reg, TmpReg27Reg,
	AwbGainHcg0Reg, AwbGainHcg1Reg, AwbGainHcg2Reg, AwbGainHcg3Reg,
	AwbGainHcg4Reg, AwbGainHcg5Reg, AwbGainHcg6Reg, AwbGainHcg7Reg,
	AwbGainLcg0Reg, AwbGainLcg1Reg, AwbGainLcg2Reg, AwbGainLcg3Reg,
	AwbGainLcg4Reg, AwbGainLcg5Reg, AwbGainLcg6Reg, AwbGainLcg7Reg,
	AwbGainSpd0Reg, AwbGainSpd1Reg, AwbGainSpd2Reg, AwbGainSpd3Reg,
	AwbGainSpd4Reg, AwbGainSpd5Reg, AwbGainSpd6Reg, AwbGainSpd7Reg,
	AwbGainVs0Reg, AwbGainVs1Reg, AwbGainVs2Reg, AwbGainVs3Reg,
	AwbGainVs4Reg, AwbGainVs5Reg, AwbGainVs6Reg, AwbGainVs7Reg,
};
